      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <input 
            ...
            placeholder="0"
            min="0"
            value={hours} // <--- Value from App.jsx
            onChange={(e) => setHours(e.target.value)} // <--- Updates App.jsx
        ...
        <div className="flex items-center gap-2">
          <input 
            type="number" 
            min="0"
            value={minutes} // <--- Value from App.jsx
            onChange={(e) => setMinutes(e.target.value)} // <--- Updates App.jsx
            className="w-20 h-16 text-4xl font-bold text-center text-forest-dark bg-white rounded-md focus:outline-none focus:ring-4 focus:ring-forest-accent"
            />
